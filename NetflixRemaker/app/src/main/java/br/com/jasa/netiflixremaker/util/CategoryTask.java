package br.com.jasa.netiflixremaker.util;
...
import br.com.jasa.netiflixremaker.model.Category;
import br.com.jasa.netiflixremaker.model.Movie;

/* carregando link externo */
public class CategoryTask extends AsyncTask<String, Void, List<Category>> {
    ...
    protected void onPostExecute(List<Category> categories) {
        ...
        dialog.dismiss();
        //listener
        if(categoryLoader != null) categoryLoader.onResult(categories);
    ...
    /* começa a integrar com o visual da lista de categorias */
